...
| `de`   | de: 0.995                           | `el`   | el: 1.000              | `es`   | es: 0.962<br>ca: 0.006<br>gn: 0.001 | `et`   | et: 1.000                                        | `fa`   | fa: 1.000               |
| `fi`   | fi: 1.000                           | `fr`   | fr: 0.958              | `gu`   | gu: 1.000                           | `ha`   | ha: 0.995<br>es: 0.001<br>gn: 0.001<br>en: 0.001 | `hi`   | hi: 0.998               |
| `hr`   | hr: 0.544<br>bs: 0.167<br>en: 0.004 | `hu`   | hu: 0.999<br>en: 0.001 | `id`   | id: 0.943<br>ms: 0.009<br>su: 0.001 | `ig`   | ig: 0.999<br>en: 0.001                           | `is`   | is: 0.999<br>en: 0.001  |
| `it`   | it: 0.998                           | `ja`   | ja: 1.000              | `kn`   | kn: 1.000                           | `ko`   | ko: 1.000                                        | `ky`   | ky: 1.000               |
| `lt`   | lt: 1.000                           | `lv`   | lv: 0.999<br>en: 0.001 | `mk`   | mk: 1.000                           | `ml`   | ml: 1.000                                        | `mr`   | mr: 0.998               |
| `nl`   | nl: 0.998<br>fy: 0.001              | `om`   | om: 0.999<br>en: 0.001 | `or`   | or: 1.000                           | `pa`   | pa: 1.000                                        | `pl`   | pl: 0.999<br>en: 0.001  |
| `ps`   | ps: 0.899<br>fa: 0.101              | `pt`   | pt: 0.996<br>gl: 0.003 | `ro`   | ro: 1.000                           | `ru`   | ru: 0.993                                        | `sn`   | sn: 0.999<br>zu: 0.001  |
| `sw`   | sw: 1.000                           | `ta`   | ta: 1.000              | `te`   | te: 1.000                           | `ti`   | ti: 1.000                                        | `tl`   | tl: 0.985<br>ilo: 0.001 |
| `tr`   | tr: 0.999                           | `uk`   | uk: 1.000              | `yo`   | yo: 0.975<br>en: 0.001              | `zh`   | zh-CN: 0.989<br>zh-TW: 0.011                     |        |                         |
