...
| `hu` | hu: 0.999<br>en: 0.001 | `id` | id: 0.943<br>ms: 0.009<br>su: 0.001              | `ig` | ig: 0.999<br>en: 0.001       | `is` | is: 0.999<br>en: 0.001                           |
| `it` | it: 0.998              | `ja` | ja: 1.000                                        | `kn` | kn: 1.000                    | `ko` | ko: 1.000                                        |
| `ky` | ky: 1.000              | `lt` | lt: 1.000                                        | `lv` | lv: 0.999<br>en: 0.001       | `mk` | mk: 1.000                                        |
| `ml` | ml: 1.000              | `mr` | mr: 0.998                                        | `nl` | nl: 0.998<br>fy: 0.001       | `om` | om: 0.999<br>en: 0.001                           |
| `or` | or: 1.000              | `pa` | pa: 1.000                                        | `pl` | pl: 0.999<br>en: 0.001       | `ps` | ps: 0.899<br>fa: 0.101                           |
| `pt` | pt: 0.996<br>gl: 0.003 | `ro` | ro: 1.000                                        | `ru` | ru: 0.993                    | `rw` | rw: 0.893<br>en: 0.102<br>de: 0.003<br>fr: 0.001 |
| `sn` | sn: 0.999<br>zu: 0.001 | `so` | so: 0.740<br>en: 0.251<br>om: 0.001              | `sw` | sw: 1.000                    | `ta` | ta: 1.000                                        |
| `te` | te: 1.000              | `ti` | ti: 1.000                                        | `tl` | tl: 0.985<br>ilo: 0.001      | `tr` | tr: 0.999                                        |
| `uk` | uk: 1.000              | `yo` | yo: 0.975<br>en: 0.001                           | `zh` | zh-CN: 0.989<br>zh-TW: 0.011 |      |                                                  |
